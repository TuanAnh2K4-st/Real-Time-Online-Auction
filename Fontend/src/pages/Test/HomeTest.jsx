...
const TOP_SELLERS = [
  ...
  {
    id: 3,
    name: "Antique Heritage",
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200",
    successSales: "2,100+",
    rating: 5.0,
    category: "Cổ vật & Nghệ thuật"
  }
];
...
const NORMAL_AUCTIONS = [
  ...
  {
    id: 2,
    title: "Tượng Phật Di Lặc Gỗ Sưa Đỏ Ngàn Năm",
    currentBid: 245000000,
    bidsCount: 15,
    timeLeft: "2 ngày 05 giờ",
  ...
  {
    id: 4,
    title: "Xe Moto Ducati Panigale V4 S - Mới 100%",
    currentBid: 950000000,
    bidsCount: 28,
    timeLeft: "04:22:10",
    image: "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?auto=format&fit=crop&q=80&w=800",
    category: "Xe phân khối lớn",
    hot: true
  }
];
...
/**
 * Thành phần Nút tìm kiếm có hiệu ứng đóng mở sửa lại
 */
const SearchBar = () => {
  ...
  // Xử lý phím tắt Cmd+K hoặc Ctrl+K để focus tìm kiếm
  useEffect(() => {
  ...
  const closeSearch = () => {
    setIsExpanded(false);
    setSearchValue(""); // Xóa trắng khi đóng
  };
  ...
  return (
    <div className="relative flex items-center">
      ...
      >
        <div 
          className={`p-3 transition-colors ${isExpanded ? 'text-blue-400' : 'text-slate-400'}`}
        >
  ...
  return (
    <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center bg-white/5 p-1 rounded-2xl border border-white/10 backdrop-blur-md">
          {['Trang chủ', 'Đấu Live', 'Lịch sử', 'Hướng dẫn'].map((item, i) => (
            <a 
              key={item} 
              href="#" 
              className={`px-5 py-2 rounded-xl text-sm font-bold transition-all ${
                i === 0 ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-slate-400 hover:text-white'
              }`}
            >
              {item}
            </a>
        ...
        <div className="flex items-center gap-4">
          <SearchBar />
          <button className="flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-2xl font-bold hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-900/40">
...
// ... Các thành phần khác giữ nguyên (HeroBanner, SellerSection, LiveAuctionCard, ProductCard)
const HeroBanner = () => {
