...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 selection:bg-blue-500/30 font-sans pb-20">
      <nav className="fixed top-0 w-full z-[100] bg-slate-950/80 backdrop-blur-xl border-b border-white/5 py-3">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
             <button className="p-2.5 bg-blue-600 text-white rounded-xl"><User className="w-5 h-5" /></button>
          </div>
        </div>
      </nav>
