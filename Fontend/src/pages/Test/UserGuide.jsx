      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-3 cursor-pointer group">
          ...
          <span className="text-2xl font-black text-white tracking-tighter uppercase italic">
            DAUGIA<span className="text-blue-400">VIET</span>
          </span>
        </div>
          ...
          {['Trang chủ', 'Đấu Live', 'Lịch sử', 'Hướng dẫn'].map((item, i) => (
            <a 
              ...
              className={`px-5 py-2 rounded-xl text-sm font-bold transition-all ${
                item === 'Hướng dẫn' ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-slate-400 hover:text-white'
              }`}
            >
              {item}
            </a>
          ...
          <div className="relative p-12 md:p-20 bg-slate-900/50 border border-white/10 rounded-[3rem] text-center overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <button className="px-10 py-5 bg-white/5 text-white border border-white/10 rounded-2xl font-black text-lg hover:bg-white/10 transition-all flex items-center gap-3">
