...
const App = () => {
  ...
  const deleteNotification = (id) => {
    ...
    if (selectedNotification?.notificationId === id) setSelectedNotification(null);
  };
      ...
      <main className="max-w-4xl mx-auto px-6 pt-12 md:pt-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <div className="flex items-center gap-3">
             <button onClick={markAllAsRead} className="group p-3 bg-slate-900 border border-white/5 rounded-2xl text-slate-400 hover:text-blue-400 hover:border-blue-500/50 transition-all shadow-xl flex items-center gap-2" title="Đánh dấu đã đọc tất cả">
